...
const dict: Dict = {
  ...
  "hero.tagline": {
    en: "Shop from your favorite local stores from the comfort of your home",
    ur: "اپنے گھر کے آرام سے اپنی پسندیدہ مقامی دکانوں سے خریداری کریں",
  },
  "hero.search.placeholder": {
    en: "Search products or shops…",
    ur: "پروڈکٹس یا دکانیں تلاش کریں…",
  },
  ...
  "section.becomeVendor.body": {
    en: "Bring your shop to Shahar Bazar",
    ur: "اپنی دکان شہر بازار پر لائیں",
  },

  "cat.grocery": { en: "Grocery", ur: "گروسری" },
  "cat.grocery.body": {
    en: "Fresh produce, spices & daily essentials",
    ur: "تازہ سبزیاں، مصالحے اور روزمرہ اشیاء",
  },
  "cat.services": { en: "Services", ur: "خدمات" },
  "cat.services.body": {
    en: "Plumbers, electricians, mechanics & more",
    ur: "پلمبر، الیکٹریشن، مکینک اور مزید",
  },
  ...
  "why.vendors.body": {
    en: "Support your trusted neighborhood shops",
    ur: "اپنی قابل اعتماد محلے کی دکانوں کا ساتھ دیں",
  },
  "why.secure.title": { en: "Secure Orders", ur: "محفوظ آرڈرز" },
  "why.secure.body": {
    en: "Safe payments & quality guaranteed",
    ur: "محفوظ ادائیگیاں اور معیار کی ضمانت",
  },

  "how.1.title": { en: "Search nearby", ur: "قریب تلاش کریں" },
  "how.1.body": {
    en: "Browse by category to find shops & providers near you.",
    ur: "اپنے قریب دکانیں اور فراہم کنندگان تلاش کرنے کے لیے زمرہ کے حساب سے براؤز کریں۔",
  },
  "how.2.title": { en: "Compare & chat", ur: "موازنہ اور چیٹ" },
  "how.2.body": {
    en: "Read reviews, compare prices, and chat before you book.",
    ur: "بک کرنے سے پہلے جائزے پڑھیں، قیمتوں کا موازنہ کریں اور چیٹ کریں۔",
  },
  "how.3.title": { en: "Book or buy", ur: "بک کریں یا خریدیں" },
  "how.3.body": {
    en: "Book a service visit or order from local shops in one tap.",
    ur: "ایک ٹیپ میں سروس وزٹ بک کریں یا مقامی دکانوں سے آرڈر کریں۔",
  },
  ...
  "auth.subtitle": {
    ...
    ur: "جاری رکھنے کے لیے لاگ ان کریں یا اکاؤنٹ بنائیں",
  },
  ...
  "footer.newsletter.body": {
    en: "Subscribe for special offers",
    ur: "خصوصی پیشکشوں کے لیے سبسکرائب کریں",
  },
